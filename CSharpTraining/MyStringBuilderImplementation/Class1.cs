...
namespace System.Text
{
    ...
    public sealed class StringBuilder 
    {
        ...
        public StringBuilder(String value, int startIndex, int length, int capacity)
        {
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException("capacity","ArgumentOutOfRange_MustBePositive", "capacity");
            }
            if (length < 0)
            {
                throw new ArgumentOutOfRangeException("length","ArgumentOutOfRange_MustBeNonNegNum", "length");
            }
            if (startIndex < 0)
            {
        ...
        public StringBuilder(int capacity, int maxCapacity)
        {
            ...
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException("capacity",
                                                      "ArgumentOutOfRange_MustBePositive", "capacity");
            }
            Contract.EndContractBlock();
